...
_TESTSCHEDULECONFIGMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gsi_vendor_version', full_name='android.test.lab.TestScheduleConfigMessage.gsi_vendor_version', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_storage_type', full_name='android.test.lab.TestScheduleConfigMessage.test_storage_type', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_branch', full_name='android.test.lab.TestScheduleConfigMessage.test_branch', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_build_target', full_name='android.test.lab.TestScheduleConfigMessage.test_build_target', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_pab_account_id', full_name='android.test.lab.TestScheduleConfigMessage.test_pab_account_id', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='retry_count', full_name='android.test.lab.TestScheduleConfigMessage.retry_count', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disable', full_name='android.test.lab.TestScheduleConfigMessage.disable', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_package_repo_base', full_name='android.test.lab.TestScheduleConfigMessage.image_package_repo_base', index=17,
