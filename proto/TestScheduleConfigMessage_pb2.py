...
_TESTSCHEDULECONFIGMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disable', full_name='android.test.lab.TestScheduleConfigMessage.disable', index=13,
